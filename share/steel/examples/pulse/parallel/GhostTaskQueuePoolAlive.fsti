...
let own_res (#a: Type0) (r: ref (option a)) = (exists* v. pts_to r #one_quart v)
...
let task_elem: Type u#1 = (
  ...
  & Lock.lock (own_res r) // 1/4 permission to the reference
)
...
val pool: Type0 // implemented as a ghost mono ref and a ghost bool ref
...
val init_ghost_queue: stt_ghost pool emp (fun p -> small_inv p [] 0)
