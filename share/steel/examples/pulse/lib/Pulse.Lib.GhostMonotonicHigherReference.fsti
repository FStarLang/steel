...
val write (#a:Type) (#p:Preorder.preorder a) (#v:a)
          (r:ref a p) (x:a)
  : stt_ghost unit (pts_to r full_perm v ** pure (squash (p v x)))
...
val gather (#a:Type)
           ...
           (v1 v2:a)
  : stt_ghost unit 
    (pts_to r f v1 ** pts_to r g v2)
    (fun _ -> pts_to r (sum_perm f g) v1 ** pure (v1 == v2))
