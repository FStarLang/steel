...
type ('dummyV0, 'dummyV1, 'dummyV2) st_typing =
  ...
  * Pulse_Syntax_Base.comp * Pulse_Syntax_Base.var * unit * unit * unit *
  ...
  | T_SubInvsGhost of Pulse_Typing_Env.env * Pulse_Syntax_Base.st_term *
  Pulse_Syntax_Base.term * Pulse_Syntax_Base.term * Pulse_Syntax_Base.st_comp
  * unit * (unit, unit, unit) st_typing 
  | T_SubInvsAtomic of Pulse_Typing_Env.env * Pulse_Syntax_Base.st_term *
  Pulse_Syntax_Base.term * Pulse_Syntax_Base.term * Pulse_Syntax_Base.st_comp
  * unit * (unit, unit, unit) st_typing 
...
let uu___is_T_SubInvsGhost uu___2 uu___1 uu___ uu___3 =
  match uu___3 with | T_SubInvsGhost _ -> true | _ -> false
let uu___is_T_SubInvsAtomic uu___2 uu___1 uu___ uu___3 =
  match uu___3 with | T_SubInvsAtomic _ -> true | _ -> false
