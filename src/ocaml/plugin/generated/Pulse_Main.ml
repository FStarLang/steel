      ...
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (58))
               (Prims.of_int (18)) (Prims.of_int (58)) (Prims.of_int (32)))))
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (59))
               (Prims.of_int (2)) (Prims.of_int (63)) (Prims.of_int (4)))))
                 ...
                 (Obj.magic
                    (FStar_Tactics_Effect.tac_bind
                             ...
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range "Pulse.Main.fst"
                                      ...
                                      (Prims.of_int (59)) (Prims.of_int (21)))))
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range "Pulse.Main.fst"
                                      (Prims.of_int (59)) (Prims.of_int (12))
                                      (Prims.of_int (59)) (Prims.of_int (34)))))
                             (Obj.magic (FStar_Tactics_V1_Derived.goals ()))
                             (fun uu___1 ->
                                FStar_Tactics_Effect.lift_div_tac
                                  (fun uu___2 ->
                       ...
                       (fun uu___1 ->
                          (fun uu___1 ->
                             Obj.magic
                               (FStar_Tactics_V1_Builtins.set_goals uu___1))
                            uu___1)))
                 (fun uu___1 ->
                    (fun uu___1 ->
                       Obj.magic
          ...
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (69))
                   (Prims.of_int (2)) (Prims.of_int (69)) (Prims.of_int (22)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Main.fst" (Prims.of_int (69))
                   (Prims.of_int (23)) (Prims.of_int (75)) (Prims.of_int (5)))))
          (Obj.magic
                     ...
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Main.fst"
                              ...
                              (Prims.of_int (71)) (Prims.of_int (25)))))
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Main.fst"
                              (Prims.of_int (73)) (Prims.of_int (2))
              ...
              fun env ->
                FStar_Tactics_Effect.tac_bind
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Main.fst"
                           (Prims.of_int (85)) (Prims.of_int (12))
                           (Prims.of_int (85)) (Prims.of_int (97)))))
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range "Pulse.Main.fst"
