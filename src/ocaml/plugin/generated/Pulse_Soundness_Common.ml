open Prims
type ln_comp = Pulse_Syntax.comp_st
let (bind_res :
        ...
        fun post1 ->
          fun post2 ->
            Pulse_Reflection_Util.mk_arrow
              ...
              (bind_res u2 t2
                 (FStar_Reflection_Derived.mk_app post1
                    [((Pulse_Reflection_Util.bound_var Prims.int_zero),
                       FStar_Reflection_Data.Q_Explicit)]) post2)
          ...
          fun pre ->
            fun post1 ->
              fun post2 ->
                ...
                Pulse_Reflection_Util.mk_arrow
                  (f_type, FStar_Reflection_Data.Q_Explicit)
                  (bind_type_t1_t2_pre_post1_post2_f u1 u2 t1 t2 pre post1
                     post2)
let (post2_type_bind :
  FStar_Reflection_Types.term -> FStar_Reflection_Types.term) =
  fun t2 ->
    Pulse_Reflection_Util.mk_arrow (t2, FStar_Reflection_Data.Q_Explicit)
          ...
          fun pre ->
            fun post1 ->
              ...
              Pulse_Reflection_Util.mk_arrow
                ...
                (FStar_Reflection_Typing.open_or_close_term'
                   (bind_type_t1_t2_pre_post1_post2 u1 u2 t1 t2 pre post1
                      post2) (FStar_Reflection_Typing.CloseVar var)
                   Prims.int_zero)
let (post1_type_bind :
  FStar_Reflection_Types.term -> FStar_Reflection_Types.term) =
  fun t1 ->
    Pulse_Reflection_Util.mk_arrow (t1, FStar_Reflection_Data.Q_Explicit)
      Pulse_Reflection_Util.vprop_tm
          ...
          fun pre ->
            ...
            Pulse_Reflection_Util.mk_arrow
              ...
              (FStar_Reflection_Typing.open_or_close_term'
                 ...
                 (FStar_Reflection_Typing.CloseVar var) Prims.int_zero)
let (bind_type_t1_t2 :
  FStar_Reflection_Types.universe ->
    FStar_Reflection_Types.universe ->
      FStar_Reflection_Types.term ->
  ...
  fun u1 ->
    fun u2 ->
      ...
      Pulse_Reflection_Util.mk_arrow
        ...
        (FStar_Reflection_Typing.open_or_close_term' (bind_type_t1 u1 u2 t1)
           (FStar_Reflection_Typing.CloseVar var) Prims.int_zero)
let (mk_star :
  FStar_Reflection_Types.term ->
    FStar_Reflection_Types.term -> FStar_Reflection_Types.term)
          ...
          fun frame ->
            Pulse_Reflection_Util.mk_stt_comp u t (mk_star pre frame)
              (Pulse_Reflection_Util.mk_abs t
                 FStar_Reflection_Data.Q_Explicit
                 (mk_star
                    (FStar_Reflection_Derived.mk_app post
                       [((Pulse_Reflection_Util.bound_var Prims.int_zero),
                          FStar_Reflection_Data.Q_Explicit)]) frame))
  ...
  fun u ->
    fun t ->
      fun pre ->
        ...
        Pulse_Reflection_Util.mk_arrow
          (post_type, FStar_Reflection_Data.Q_Implicit)
          (FStar_Reflection_Typing.close_term
...
let (frame_type :
  ...
  fun u ->
    ...
    Pulse_Reflection_Util.mk_arrow (t_type, FStar_Reflection_Data.Q_Implicit)
...
let (stt_vprop_post_equiv_univ_inst :
  ...
  fun u ->
    FStar_Reflection_Builtins.pack_ln
      (FStar_Reflection_Data.Tv_UInst (stt_vprop_post_equiv_fv, [u]))
let (stt_vprop_post_equiv :
  ...
  fun u ->
    fun t ->
      fun t1 ->
        fun t2 ->
          FStar_Reflection_Derived.mk_app (stt_vprop_post_equiv_univ_inst u)
          ...
          fun pre2 ->
            ...
            let post2_type =
              Pulse_Reflection_Util.mk_arrow
                ...
                Pulse_Reflection_Util.vprop_tm in
            Pulse_Reflection_Util.mk_arrow
              (post2_type, FStar_Reflection_Data.Q_Explicit)
              (FStar_Reflection_Typing.close_term
    ...
    fun t ->
      fun pre1 ->
        fun post1 ->
          ...
          Pulse_Reflection_Util.mk_arrow
            (pre2_type, FStar_Reflection_Data.Q_Explicit)
            (FStar_Reflection_Typing.close_term
      ...
      fun pre1 ->
        ...
        let post1_type =
          Pulse_Reflection_Util.mk_arrow
            ...
            Pulse_Reflection_Util.vprop_tm in
        Pulse_Reflection_Util.mk_arrow
          (post1_type, FStar_Reflection_Data.Q_Explicit)
...
let (sub_stt_pre1 :
  ...
  fun u ->
    fun t ->
      ...
      Pulse_Reflection_Util.mk_arrow
        (pre1_type, FStar_Reflection_Data.Q_Explicit)
...
type stt_env = FStar_Reflection_Typing.fstar_top_env
let (check_top_level_environment :
  FStar_Reflection_Typing.fstar_top_env ->
    stt_env FStar_Pervasives_Native.option)
  = fun f -> FStar_Pervasives_Native.Some f
let (elab_comp_post : Pulse_Syntax.comp_st -> FStar_Reflection_Types.term) =
  fun c ->
    let t = Pulse_Elaborate_Pure.elab_term (Pulse_Syntax.comp_res c) in
    let post = Pulse_Elaborate_Pure.elab_term (Pulse_Syntax.comp_post c) in
    Pulse_Reflection_Util.mk_abs t FStar_Reflection_Data.Q_Explicit post
let (comp_post_type : Pulse_Syntax.comp_st -> FStar_Reflection_Types.term) =
  fun c ->
    let t = Pulse_Elaborate_Pure.elab_term (Pulse_Syntax.comp_res c) in
    Pulse_Reflection_Util.mk_arrow (t, FStar_Reflection_Data.Q_Explicit)
      Pulse_Reflection_Util.vprop_tm
