            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Checker.Prover.Match.fst"
                     ...
                     (Prims.of_int (323)) (Prims.of_int (27)))))
            (Obj.magic (unify g uvs p q Pulse_Checker_Prover_Substs.empty))
            (fun r ->
               FStar_Tactics_Effect.lift_div_tac
                 (fun uu___ ->
                    match r with
                  ...
                  (FStar_Sealed.seal
                     (Obj.magic
                        (FStar_Range.mk_range
                           ...
                           (Prims.of_int (398)) (Prims.of_int (11)))))
                  (FStar_Tactics_Effect.lift_div_tac
                     (fun uu___1 ->
                        Pulse_Checker_Prover_Base.op_Array_Access
                          ...
                          (FStar_Tactics_Effect.tac_bind
                             ...
                             (FStar_Sealed.seal
                                (Obj.magic
                                   (FStar_Range.mk_range
                                      "Pulse.Checker.Prover.Match.fst"
                                      (Prims.of_int (339)) Prims.int_zero
                                      (Prims.of_int (398))
                                      (Prims.of_int (11)))))
                             (Obj.magic
                                (try_match_pq
