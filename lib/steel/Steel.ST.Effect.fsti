...
val bind (a:Type) (b:Type)
  (#framed_f:bool)
  (#framed_g:bool)
  (#[@@@ defer_to framing_implicit] pre_f:pre_t)
  (#[@@@ defer_to framing_implicit] post_f:post_t a)
  (#[@@@ defer_to framing_implicit] req_f:pure_pre)
  (#[@@@ defer_to framing_implicit] ens_f:pure_post a)
  (#[@@@ defer_to framing_implicit] pre_g:a -> pre_t)
  (#[@@@ defer_to framing_implicit] post_g:a -> post_t b)
  (#[@@@ defer_to framing_implicit] req_g:a -> pure_pre)
  (#[@@@ defer_to framing_implicit] ens_g:(a -> pure_post b))
  (#[@@@ defer_to framing_implicit] frame_f:vprop)
  (#[@@@ defer_to framing_implicit] frame_g:a -> vprop)
...
val subcomp (a:Type)
  ...
  (#[@@@ defer_to framing_implicit] req_f:pure_pre)
  (#[@@@ defer_to framing_implicit] ens_f:pure_post a)
  (#[@@@ defer_to framing_implicit] pre_g:pre_t)
  (#[@@@ defer_to framing_implicit] post_g:post_t a)
  (#[@@@ defer_to framing_implicit] req_g:pure_pre)
  (#[@@@ defer_to framing_implicit] ens_g:pure_post a)
  (#[@@@ defer_to framing_implicit] frame:vprop)
  (#[@@@ defer_to framing_implicit] _ : squash (maybe_emp framed_f frame))
  (#[@@@ defer_to framing_implicit] p1:squash (can_be_split pre_g (pre_f `star` frame)))
...
let if_then_else (a:Type)
  ...
  (#[@@@ defer_to framing_implicit] post_f:post_t a)
  (#[@@@ defer_to framing_implicit] post_g:post_t a)
  (#[@@@ defer_to framing_implicit] req_then:pure_pre)
  (#[@@@ defer_to framing_implicit] ens_then:pure_post a)
  (#[@@@ defer_to framing_implicit] req_else:pure_pre)
  (#[@@@ defer_to framing_implicit] ens_else:pure_post a)
  (#[@@@ defer_to framing_implicit] frame_f : vprop)
  ...
  (#[@@@ defer_to framing_implicit] s_pre: squash (can_be_split (pre_f `star` frame_f) (pre_g `star` frame_g)))
