...
let bind (a:Type) (b:Type)
         ...
         (#[@@@ defer_to framing_implicit] req_f:Type0)
         (#[@@@ defer_to framing_implicit] ens_f:a -> Type0)
         (#[@@@ defer_to framing_implicit] pre_g:a -> pre_t)
         (#[@@@ defer_to framing_implicit] post_g:a -> post_t b)
         (#[@@@ defer_to framing_implicit] req_g:(a -> Type0))
         (#[@@@ defer_to framing_implicit] ens_g:(a -> b -> Type0))
...
let subcomp (a:Type)
            ...
            (#[@@@ defer_to framing_implicit] req_g:Type0)
            (#[@@@ defer_to framing_implicit] ens_g:a -> Type0)
