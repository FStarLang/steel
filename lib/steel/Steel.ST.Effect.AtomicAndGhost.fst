...
let bind (a:Type) (b:Type)
         ...
         (#[@@@ defer_to framing_implicit] _x1 : squash (maybe_emp framed_f frame_f))
         (#[@@@ defer_to framing_implicit] _x2 : squash (maybe_emp_dep framed_g frame_g))
...
let subcomp (a:Type)
            ...
            (#[@@@ defer_to framing_implicit] _x : squash (maybe_emp framed_f frame))
